##################################
# Win10 Pro Initial Setup Script #
# last update: 2021-11-12        #
##################################

########################################
#             == WARNING ==            #
# Not tested on other windows version! #
########################################

# Credits note: this is a collection of content from various sources(reddit,forum,web,etc) around the internet collected over the years.
